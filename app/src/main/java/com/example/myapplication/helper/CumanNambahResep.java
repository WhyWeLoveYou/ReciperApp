...
import com.example.myapplication.databinding.TambahResepBinding;
...
public class CumanNambahResep extends AppCompatActivity {

    private TambahResepBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = TambahResepBinding.inflate(getLayoutInflater());
    ...
    private void addDataToFirestore(String Gambar) {
        ...
        String url = binding.InputPw.getText().toString();
    ...
    private Boolean validator() {
        if (binding.InputAlamat.getText().toString() == null) {
